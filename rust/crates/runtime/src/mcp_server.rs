...
//! server can be driven by either an external MCP client (e.g. Himalaya
//! Desktop) or `Himalaya`'s own [`McpServerManager`](crate::McpServerManager).
//!
