...
pub const DEFAULT_APP_NAME: &str = "Himalaya-code";
pub const DEFAULT_RUNTIME: &str = "rust";
pub const DEFAULT_AGENTIC_BETA: &str = "Himalaya-code-20250219";
...
mod tests {
    ...
    fn request_profile_emits_headers_and_merges_body() {
        let profile = AnthropicRequestProfile::new(
            ClientIdentity::new("Himalaya-code", "1.2.3").with_runtime("rust-cli"),
        )
        ...
        assert_eq!(
            ...
            vec![
                ...
                ("user-agent".to_string(), "Himalaya-code/1.2.3".to_string()),
                (
                    "anthropic-beta".to_string(),
                    "Himalaya-code-20250219,prompt-caching-scope-2026-01-05,tools-2026-04-01"
                        .to_string(),
                ),
            ]
        );
        ...
        let body = profile
            .render_json_body(&serde_json::json!({"model": "Himalaya-sonnet"}))
    ...
    fn session_tracer_records_structured_events_and_trace_sequence() {
        ...
        tracer.record_analytics(
            AnalyticsEvent::new("cli", "prompt_sent")
                .with_property("model", Value::String("Himalaya-opus".to_string())),
        );
