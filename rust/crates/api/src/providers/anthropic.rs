...
impl AnthropicClient {
    ...
    async fn send_raw_request(
        ...
        rewrite_image_blocks_for_anthropic(&mut request_body);
...
/// Rewrite flat image blocks produced by serde into Anthropic's nested source
/// format.
///
/// The internal `InputContentBlock::Image` serializes as:
/// `{"type":"image","data":"...","media_type":"..."}`.
///
/// The Anthropic API expects:
/// `{"type":"image","source":{"type":"base64","media_type":"...","data":"..."}}`.
fn rewrite_image_blocks_for_anthropic(body: &mut Value) {
    ...
    for message in messages.iter_mut() {
        ...
        for block in content.iter_mut() {
            ...
            let data = block["data"].take();
            let media_type = block["media_type"].take();
...
mod tests {
    ...
    fn strip_unsupported_beta_body_fields_removes_betas_array() {
        let mut body = serde_json::json!({
            ...
            "max_tokens": 1024,
            "betas": ["Himalaya-code-20250219", "prompt-caching-scope-2026-01-05"],
