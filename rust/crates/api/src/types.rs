...
pub enum InputContentBlock {
    ...
    /// Vision image block. Stored as flat fields; each provider translates
    /// to its own wire format (Anthropic nested source, OpenAI image_url).
    Image {
...
mod tests {
    ...
    fn message_response_estimates_cost_from_model_usage() {
        let response = MessageResponse {
            ...
            content: Vec::new(),
            model: "Himalaya-sonnet-4-20250514".to_string(),
